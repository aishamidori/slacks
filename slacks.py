...
ARGS_AUX_HOUR_PREFIX = 'aux hours: ' # Prefix for args help string.
...
def set_and_parse_args():
    ...
    group.add_argument('-a', '--add', nargs=2, metavar=('MIN', 'COMMENT'),
            action='store', help=ARGS_AUX_HOUR_PREFIX + 'add MIN minutes with '
            'COMMENT')
    group.add_argument('-d', '--delete', action='store_true',
            help=ARGS_AUX_HOUR_PREFIX + 'deletes the most recent hours block')
    parser.add_argument('-l', '--list', action='store_true',
            help=ARGS_AUX_HOUR_PREFIX + 'display logged hours')
